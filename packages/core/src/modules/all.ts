...
export const MODULES: VishuModule[] = [artifactsModule, browserModule, desktopModule, devopsModule, imagegenModule, pairingModule, reportModule, selfUpdateModule, voiceModule, walletModule];
